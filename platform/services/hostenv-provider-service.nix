...
let
  ...
  serviceSrc = builtins.path {
    path = ./hostenv-provider-service;
    name = "hostenv-provider-service-src";
  };
  haskellDeps = import ./hostenv-provider-service/haskell-deps.nix;
    ...
    package = lib.mkOption {
      ...
      defaultText = lib.literalExpression ''
        pkgs.writeShellScriptBin "hostenv-provider-service" '''
          exec ''${pkgs.haskellPackages.ghcWithPackages [ ... ]}/bin/runghc -i''${./.} ''${./.}/Main.hs
        ''';
      '';
