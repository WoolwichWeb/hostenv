# This file defines the per-location options for the environment nginx module.
# It is forked from nixpkgs' `services.web-servers.nginx.location-options`
# but lives in the env layer to avoid importing NixOS host modules.
{ lib, config }:
